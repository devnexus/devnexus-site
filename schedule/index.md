...
<section class="day-content day0" id="day0">
<h2 class="text-2xl font-bold px-4 py-5 bg-zinc-900 text-black border-b-4 border-white text-center">Wednesday Mar 4 - Day 0</h2>
  {% assign rooms = day0_times[0].rooms | sort: "name" %}
    <div class="timeline-slot mb-5" data-time="{{ slot.slotStart }}" data-day="day0">
        <div class="time-header bg-black text-white px-4 py-2.5 font-bold border-4 border-black">
            <span>Workshops 9.00 am - 5.00 pm *** Workshop Tickets Required ***</span>
        </div>
        <div class="border-4 border-black bg-white border-t-0 p-4">
            {% for e in rooms %} 
...
<section class="day-content day1" id="day1">
  <h2 class="text-2xl font-bold px-4 py-5 bg-zinc-900 text-black border-b-4 border-white text-center">Thursday Mar 5 - Day 1</h2>
