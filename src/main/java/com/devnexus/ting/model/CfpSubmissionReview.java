...
@Table(uniqueConstraints=@UniqueConstraint(columnNames={"created_by_user_id", "cfp_submission_id"}))
public class CfpSubmissionReview extends BaseModelObject {
	...
	public CfpSubmissionReview() {
	}

	public CfpSubmissionReview(Long id) {
		this.id = id;
	}
