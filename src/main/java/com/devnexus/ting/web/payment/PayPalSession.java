...
public final class PayPalSession {
	...
	public static PayPalSession getSession(String clientId, String clientSecret) {
		// PayPalSession session = CLIENT_MAP.computeIfAbsent(clientId, (ignore)
		// ->new PayPalSession(clientId, clientSecret, "sandbox"));
		// if (session.isExpired()) {
		// session = CLIENT_MAP.compute(clientId, (ignoreClientId,
		// ignoreCurrentSession) ->new PayPalSession(clientId, clientSecret,
		// "sandbox"));
		// }
		// return session;
	...
	public static PayPalSession getLiveSession(String clientId, String clientSecret) {
		// PayPalSession session = CLIENT_MAP.computeIfAbsent(clientId, (ignore)
		// ->new PayPalSession(clientId, clientSecret, "live"));
		// if (session.isExpired()) {
		// session = CLIENT_MAP.compute(clientId, (ignoreClientId,
		// ignoreCurrentSession) ->new PayPalSession(clientId, clientSecret,
		// "live"));
