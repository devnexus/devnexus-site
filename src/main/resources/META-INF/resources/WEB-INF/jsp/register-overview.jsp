...
<title>${contextEvent.title} | Registration Overview</title>
        ...
        <div class="row centered">
            <div class="col-md-10 col-md-offset-1">
                <div class="top-intro travel">
                    ...
                    <h5 class="intro-white-lead">1600+ attendees, 90+ Speakers, 13 tracks, 2 Conference Days + 1 Workshop Day.</h5>
                </div>
            </div>
        </div>
    </div>
...
<section id="speaker" class="bg-light-gray">
	<div class="container">
		...
		<div class="row price-box text-center">
			<div class="col-md-8 col-md-offset-2 price-box-inner">
				<div class="price-box-main">
					<h2 >LATE WORKSHOPS + <br/>MAIN CONF TICKET: <strong>$635 - $735</strong></h2>
					<a href="${baseSiteUrl}/register" class="btn btn-primary">Buy</a>
				</div>
				<div class="price-box-aux">
		...
		<div class="row price-box text-center">
			<div class="col-md-8 col-md-offset-2 price-box-inner">
				<div class="price-box-main">
					<h2 >LATE GROUP (5+) WORKSHOP + <br/> MAIN CONF COMBO: <strong>$595 - $695</strong></h2>
		...
		<div class="row text-center">
			<div class="col-md-8 col-md-offset-2 package-details-box">
				...
				<div class="package-details">Awesome content in <strong>13 Tracks</strong> on Feb 16th &amp; 17th</div>
				<div class="package-details package-offset"><strong>2 Keynotes</strong></div>
				<div class="package-details"><strong>128+ sessions</strong></div>
				...
				<div class="package-details package-offset">Mix and mingle <strong>Happy Hour</strong> on Feb 16th <br/> with <strong>2 bands</strong> and the <strong>live recording</strong> of the <a href="http://www.javaoffheap.com/" target="_blank">Java Pub House Off Heap Podcast</a></div>
			</div>
		</div>
