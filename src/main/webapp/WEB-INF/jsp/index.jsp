    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>We accept the following payment methods during our online registration process:</p>

                <p><strong>Credit card:</strong> we accept American Express, MasterCard, and Visa.</p>

                <p><strong>Check:</strong> if choosing this method, make sure to send your check as early as possible.
                    Registration must be paid prior to the event.</p>
            </div>
        </div>
