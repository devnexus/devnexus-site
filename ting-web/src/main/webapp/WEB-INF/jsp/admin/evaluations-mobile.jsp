	...
	<div data-role="content">
		<ul data-role="listview" data-inset="true" data-theme="c"
			...
			<c:forEach items="${organizerList.organizers}" var="organizer">
				<li><a href="#${organizer.firstName}_${organizer.lastName}"><img
						src="${ctx}${baseSiteUrl}/organizers/${organizer.id}.jpg" /> <c:out
...
<c:forEach items="${organizerList.organizers}" var="organizer">
	<!-- Start of page -->
	<div data-role="page" id="${organizer.firstName}_${organizer.lastName}"
		data-theme="b">
