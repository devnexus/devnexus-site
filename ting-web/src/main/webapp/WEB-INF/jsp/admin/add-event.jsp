...
<div class="quote"><span>What the community says:</span> "great networking opportunity, excellent technical knowledge transfer"</div>
    ...
    <form:form id="form" method="post" modelAttribute="eventForm" cssClass="cleanform">
      ...
      <div class="required">
        ...
        <div class="required">
            <label for="current">Current Event</label>
            <form:checkbox path="event.current" id="current" tabindex="3"/>
            <form:errors path="event.current" cssClass="fieldError"/>
        </div>
        <div class="required">
            <label for="speakers">Speakers</label>
            <form:select multiple="true" path="event.speakers" id="speakers" tabindex="4" size="10" cssStyle="width: 200px;">
