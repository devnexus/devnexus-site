...
<h2>Speakers</h2>
    ...
    <div class="speaker">
        ...
        <p>
          ...
          Prior to that Vincent was a founding member of Anteo Group, an award
          winning Enterprise Java solutions company where he was the Chief Technology
          Officer. Prior to that Mayers was the Director of Business Development
          for E-People UK Ltd, a London based full service software company.
        </p><p>
          Vincent continues to serve as the consulting Chief Technology Officer
          for Anteo Group and is a board member of the Atlanta Java Users Group.
          He earned a Bachelor's Degree (hons) in design from the University of
          the West Midlands in Birmingham and in another life was a full time athlete,
          competing at World Championship level in whitewater kayaking for a number
          of years.
        </p>
        <br style="clear: both;"/>
    </div>
